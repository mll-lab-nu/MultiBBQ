...
|----------|------|-------|-------------------|
| Full image set (`images/`) | ~GBs | HF dataset `MLL-Lab/MultiBBQ` | `notebooks/gen_images_*.ipynb` |
...
multibbq download        # pulls the dataset and lays out ./images/ for the harness
```
