...
for model in "${models[@]}"; do
    echo "----------------------------------------------------"
    echo "EVALUATING MODEL(UNMASKED WITH IMAGE): $model"
    echo "----------------------------------------------------"
    multibbq run --experiment unmasked_w_img "$model" --textual_context true --ambiguous true --negative true
    multibbq run --experiment unmasked_w_img "$model" --textual_context true --ambiguous true --negative false
    multibbq run --experiment unmasked_w_img "$model" --textual_context true --ambiguous false --negative true
    multibbq run --experiment unmasked_w_img "$model" --textual_context true --ambiguous false --negative false
    multibbq run --experiment unmasked_w_img "$model" --textual_context false --ambiguous true --negative true
    multibbq run --experiment unmasked_w_img "$model" --textual_context false --ambiguous true --negative false
done
