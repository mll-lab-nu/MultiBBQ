...
|---|---|---|
| `gen_template.ipynb` | Slot vocabulary into the category templates to build the MultiBBQ question/context table. | [`../templates/`](../templates/), `../data/mmbbq_temp_revised.csv`, `utils.py` (here) |
...
All notebooks run with this folder as the working directory: they read `../templates/`
