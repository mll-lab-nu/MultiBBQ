...
| `hf.py` | `multibbq download`: extract the main image set from the HuggingFace parquet configs and snapshot the realworld / perturbation repos, laying out `./data/images/` for the harness. See [`../docs/huggingface/hf.md`](../docs/huggingface/hf.md). |
